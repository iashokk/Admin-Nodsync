...
interface ExpenseTrackerProps {
  onTotalsChange?: (totalIncome: number, totalExpense: number, netProfit: number) => void;
}

export default function ExpenseTracker({ onTotalsChange = () => {} }: ExpenseTrackerProps) {
  ...
  // Notify the parent whenever totals change.
  useEffect(() => {
    onTotalsChange(totalIncome, totalExpense, netProfit);
  }, [totalIncome, totalExpense, netProfit, onTotalsChange]);
